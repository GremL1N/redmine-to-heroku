= Howto and prepared source to deploy Redmine on Heroku.
...
2. Clone this repository (or see {How to prepare Rails source}[rdoc-label:README.rdoc#how-to-prepare-rails-source]):
